# ParticipantTimeline.DamageTakenPerMinDeltas Property 
...
**VB**<br />
``` VB
Public Property DamageTakenPerMinDeltas As ParticipantTimelineData
	Get
	Set
```
...
``` C++
public:
property ParticipantTimelineData^ DamageTakenPerMinDeltas {
