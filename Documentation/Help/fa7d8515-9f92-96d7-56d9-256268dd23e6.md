# ParticipantTimeline.CreepsPerMinDeltas Property 
...
**VB**<br />
``` VB
Public Property CreepsPerMinDeltas As ParticipantTimelineData
	Get
	Set
```
...
``` C++
public:
property ParticipantTimelineData^ CreepsPerMinDeltas {
