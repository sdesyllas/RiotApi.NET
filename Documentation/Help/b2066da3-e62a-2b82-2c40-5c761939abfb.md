# ParticipantTimeline.AncientGolemAssistsPerMinCounts Property 
...
**VB**<br />
``` VB
Public Property AncientGolemAssistsPerMinCounts As ParticipantTimelineData
	Get
	Set
```
...
``` C++
public:
property ParticipantTimelineData^ AncientGolemAssistsPerMinCounts {
