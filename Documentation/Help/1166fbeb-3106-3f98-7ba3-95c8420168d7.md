# MatchListDto.MatchReference.Champion Property 
RiotApi.NET Documentation 

\[Missing <summary> documentation for "P:RiotApi.Net.RestClient.Dto.Match.MatchListDto.MatchReference.Champion"\]
...
**VB**<br />
``` VB
Public Property Champion As Long
	Get
	Set
```
