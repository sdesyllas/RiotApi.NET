# AggregatedStatsDto.TotalChampionKills Property 
RiotApi.NET Documentation 

\[Missing <summary> documentation for "P:RiotApi.Net.RestClient.Dto.Stats.Generic.AggregatedStatsDto.TotalChampionKills"\]
...
``` C++
public:
property int TotalChampionKills {
	int get ();
	void set (int value);
}
```
