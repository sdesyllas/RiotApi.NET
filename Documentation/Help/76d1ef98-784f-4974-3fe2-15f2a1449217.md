# ParticipantTimeline.VilemawAssistsPerMinCounts Property 
...
**VB**<br />
``` VB
Public Property VilemawAssistsPerMinCounts As ParticipantTimelineData
	Get
	Set
```
...
``` C++
public:
property ParticipantTimelineData^ VilemawAssistsPerMinCounts {
