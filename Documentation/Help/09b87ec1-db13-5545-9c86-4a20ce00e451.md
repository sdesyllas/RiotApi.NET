# ParticipantTimeline.ElderLizardAssistsPerMinCounts Property 
...
**VB**<br />
``` VB
Public Property ElderLizardAssistsPerMinCounts As ParticipantTimelineData
	Get
	Set
```
...
``` C++
public:
property ParticipantTimelineData^ ElderLizardAssistsPerMinCounts {
