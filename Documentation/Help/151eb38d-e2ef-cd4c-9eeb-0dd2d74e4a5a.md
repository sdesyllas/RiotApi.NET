# ParticipantTimeline.DamageTakenDiffPerMinDeltas Property 
...
**VB**<br />
``` VB
Public Property DamageTakenDiffPerMinDeltas As ParticipantTimelineData
	Get
	Set
```
...
``` C++
public:
property ParticipantTimelineData^ DamageTakenDiffPerMinDeltas {
