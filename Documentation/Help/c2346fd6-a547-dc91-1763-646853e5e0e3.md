# ParticipantTimeline.TowerKillsPerMinDeltas Property 
...
**VB**<br />
``` VB
Public Property TowerKillsPerMinDeltas As ParticipantTimelineData
	Get
	Set
```
...
``` C++
public:
property ParticipantTimelineData^ TowerKillsPerMinDeltas {
