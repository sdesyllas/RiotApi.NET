# ParticipantStats.TotalDamageDealtToChampions Property 
...
**VB**<br />
``` VB
Public Property TotalDamageDealtToChampions As Long
	Get
	Set
```
...
``` C++
public:
property long long TotalDamageDealtToChampions {
	long long get ();
