# RiotExceptionRaiser.RiotApiException Class
RiotApi.NET Documentation 

\[Missing <summary> documentation for "T:RiotApi.Net.RestClient.Helpers.RiotExceptionRaiser.RiotApiException"\]


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/c18k6c59" target="_blank">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;RiotApi.Net.RestClient.Helpers.RiotExceptionRaiser.RiotApiException<br />
...
**C++**<br />
``` C++
public ref class RiotApiException : public Exception
```

The RiotExceptionRaiser.RiotApiException type exposes the following members.
...
Initializes a new instance of the RiotExceptionRaiser.RiotApiException class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="972ff9e1-7577-df14-cf63-f4102dd13869">RiotExceptionRaiser.RiotApiException(String)</a></td><td>
Initializes a new instance of the RiotExceptionRaiser.RiotApiException class</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="a73669ae-5e82-b514-5e01-2c070d705dbc">RiotExceptionRaiser.RiotApiException(SerializationInfo, StreamingContext)</a></td><td>
Initializes a new instance of the RiotExceptionRaiser.RiotApiException class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="c876967b-4304-5ccb-24f8-24dadcf7db51">RiotExceptionRaiser.RiotApiException(String, Exception)</a></td><td>
Initializes a new instance of the RiotExceptionRaiser.RiotApiException class</td></tr></table>&nbsp;
<a href="#riotexceptionraiser.riotapiexception-class">Back to Top</a>
