# RecentGamesDto.RawStatsDto.PhysicalDamageDealtPlayer Property 
...
**VB**<br />
``` VB
Public Property PhysicalDamageDealtPlayer As Integer
	Get
	Set
```
...
``` C++
public:
property int PhysicalDamageDealtPlayer {
	int get ();
	void set (int value);
}
```
