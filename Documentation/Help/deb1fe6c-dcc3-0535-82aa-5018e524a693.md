# ParticipantTimeline.InhibitorAssistsPerMinCounts Property 
...
**VB**<br />
``` VB
Public Property InhibitorAssistsPerMinCounts As ParticipantTimelineData
	Get
	Set
```
...
``` C++
public:
property ParticipantTimelineData^ InhibitorAssistsPerMinCounts {
