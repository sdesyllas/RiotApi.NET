# ParticipantTimeline.TowerAssistsPerMinCounts Property 
...
**VB**<br />
``` VB
Public Property TowerAssistsPerMinCounts As ParticipantTimelineData
	Get
	Set
```
...
``` C++
public:
property ParticipantTimelineData^ TowerAssistsPerMinCounts {
