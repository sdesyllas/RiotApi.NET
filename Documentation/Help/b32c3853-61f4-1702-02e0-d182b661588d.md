# ParticipantTimeline.DragonKillsPerMinCounts Property 
...
**VB**<br />
``` VB
Public Property DragonKillsPerMinCounts As ParticipantTimelineData
	Get
	Set
```
...
``` C++
public:
property ParticipantTimelineData^ DragonKillsPerMinCounts {
