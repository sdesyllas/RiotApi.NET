# ParticipantTimeline.BaronAssistsPerMinCounts Property 
...
**VB**<br />
``` VB
Public Property BaronAssistsPerMinCounts As ParticipantTimelineData
	Get
	Set
```
...
``` C++
public:
property ParticipantTimelineData^ BaronAssistsPerMinCounts {
