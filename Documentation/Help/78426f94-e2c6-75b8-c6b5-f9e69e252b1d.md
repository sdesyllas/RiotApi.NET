# ParticipantTimeline.XpDiffPerMinDeltas Property 
...
**VB**<br />
``` VB
Public Property XpDiffPerMinDeltas As ParticipantTimelineData
	Get
	Set
```
...
``` C++
public:
property ParticipantTimelineData^ XpDiffPerMinDeltas {
