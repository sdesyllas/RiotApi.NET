# RecentGamesDto.RawStatsDto.NeutralMinionsKilledYourJungle Property 
...
**VB**<br />
``` VB
Public Property NeutralMinionsKilledYourJungle As Integer
	Get
	Set
```
...
``` C++
public:
property int NeutralMinionsKilledYourJungle {
	int get ();
	void set (int value);
}
```
