...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;RiotApi.Net.RestClient.Dto.LolStaticData.Item.ItemTreeDto<br />
...
**C++**<br />
``` C++
public ref class ItemTreeDto
```

The ItemTreeDto type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="b30eb568-47b2-2632-67f3-f1b2d3e7905d">ItemTreeDto</a></td><td>
Initializes a new instance of the ItemTreeDto class</td></tr></table>&nbsp;
<a href="#itemtreedto-class">Back to Top</a>
