# ParticipantTimeline.VilemawKillsPerMinCounts Property 
...
**VB**<br />
``` VB
Public Property VilemawKillsPerMinCounts As ParticipantTimelineData
	Get
	Set
```
...
``` C++
public:
property ParticipantTimelineData^ VilemawKillsPerMinCounts {
