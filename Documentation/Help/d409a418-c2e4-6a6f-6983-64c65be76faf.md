# ParticipantTimeline.BaronKillsPerMinCounts Property 
...
**VB**<br />
``` VB
Public Property BaronKillsPerMinCounts As ParticipantTimelineData
	Get
	Set
```
...
``` C++
public:
property ParticipantTimelineData^ BaronKillsPerMinCounts {
