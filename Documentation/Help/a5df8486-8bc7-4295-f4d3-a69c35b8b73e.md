...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;RiotApi.Net.RestClient.Dto.LolStaticData.Generic.LevelTipDto<br />
...
**C++**<br />
``` C++
public ref class LevelTipDto
```

The LevelTipDto type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="8facb5cb-710d-c2ff-2ed6-641ba7f92cd5">LevelTipDto</a></td><td>
Initializes a new instance of the LevelTipDto class</td></tr></table>&nbsp;
<a href="#leveltipdto-class">Back to Top</a>
