# ParticipantTimeline.CsDiffPerMinDeltas Property 
...
**VB**<br />
``` VB
Public Property CsDiffPerMinDeltas As ParticipantTimelineData
	Get
	Set
```
...
``` C++
public:
property ParticipantTimelineData^ CsDiffPerMinDeltas {
