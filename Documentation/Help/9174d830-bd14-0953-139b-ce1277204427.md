# ParticipantTimeline.GoldPerMinDeltas Property 
...
**VB**<br />
``` VB
Public Property GoldPerMinDeltas As ParticipantTimelineData
	Get
	Set
```
...
``` C++
public:
property ParticipantTimelineData^ GoldPerMinDeltas {
