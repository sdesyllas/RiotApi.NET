# ParticipantTimeline.InhibitorKillsPerMinCounts Property 
...
**VB**<br />
``` VB
Public Property InhibitorKillsPerMinCounts As ParticipantTimelineData
	Get
	Set
```
...
``` C++
public:
property ParticipantTimelineData^ InhibitorKillsPerMinCounts {
